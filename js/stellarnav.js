    ...
    var settings = $.extend(
      {
        ...
        closingDelay: 300, // controls how long the dropdowns stay open for in milliseconds
    ...
    return this.each(function () {
      ...
      $(".menu-toggle, .stellarnav-open").on("click", function (e) {
        ...
        if (settings.position == "left" || settings.position == "right") {
          ...
          nav.toggleClass("current-menu-item");

          if (nav.hasClass("current-menu-item") && nav.hasClass("mobile")) {
      ...
      $(".close-menu, .stellarnav-close").on("click", function () {
        ...
        if (settings.position == "left" || settings.position == "right") {
          ...
          //nav.find('ul:first').stop(true, true).slideUp(settings.openingSpeed).toggleClass('current-menu-item');
        }
      });
      ...
      function windowCheck() {
        ...
        if (browserWidth <= breakpoint || settings.mobileMode) {
          ...
          if (!nav.hasClass("current-menu-item") && nav.find("ul:first").is(":visible")) {
          ...
          if (nav.hasClass("current-menu-item")) {
            nav.removeClass("current-menu-item");
          }

          // ensures stellarnav is visible after resizing window
          if (!nav.hasClass("current-menu-item") && nav.find("ul:first").is(":hidden")) {
